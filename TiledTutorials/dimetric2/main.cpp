...
const char* windowTitle = "Dimetric 2 (Staggered)";
	...
	SDL_Renderer* renderer)
{
	...
	//const int mapWidth = (mapHeightInTiles + mapWidthInTiles) * halfTileWidth;
	//int leftBound = (mapHeightInTiles - 1) * halfTileWidth;
	//int leftDir = -1;
	//int rightBound = leftBound + tileWidth;
	//int rightDir = +1;
	//int x = leftBound;
	//int y = 0;
	...
	//	if (x >= rightBound)
	//	{
	//		leftBound += (leftDir * halfTileWidth);
	//		if (leftBound < 0)
	//		{
	//			leftBound = halfTileWidth;
	//			leftDir = +1;
	//		}

	//		rightBound += (rightDir * halfTileWidth);
	//		if (rightBound >= mapWidth)
	//		{
	//			rightBound = mapWidth - halfTileWidth;
	//			rightDir = -1;
	//		}
